                    ...
                    <div class="col-xl-12">
                        <nav class="navbar navbar-expand-lg">
                            <div class="container-fluid" style="justify-content: center; margin-top: 50px;">
                                <a href="./Main Page.php"><img src="./img/logo-green.png" alt="Logo" width="300px"></a>
                            </div>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row mt-5">
                    <div class="col-xl-12">
                        <div class="gobackbtn text-center">
                            <button class="btn"><a href="./Main Page.php" class="btn"><i class="bi bi-arrow-left-circle-fill"></i> Go Back</a></button>
                        </div>
                    </div>
                </div>
            </div>
